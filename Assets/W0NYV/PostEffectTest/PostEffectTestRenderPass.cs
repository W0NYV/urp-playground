...
{
    private const string RenderPassName = nameof(PostEffectTestRenderPass);
    ...
    private PostEffectTestVolume _volume;

    //コンストラクタ？
    public PostEffectTestRenderPass(bool applyToSceneView, Shader shader)
    {
        if(shader == null)
        {
            return;
    ...
    public void Setup(RenderTargetIdentifier cameraColorTarget, PostprocessTiming timing)
    {
        ...
        _volume = volumeStack.GetComponent<PostEffectTestVolume>();
    }
